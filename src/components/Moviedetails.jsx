            ...
            <div className="w-full flex flex-col md:flex-row gap-8">
                ...
                <div className="content text-white">
                    ...
                    <div className="mt-3 mb-5 flex flex-wrap items-center gap-3">
                        ...
                        <h1 className="font-semibold text-xl md:text-2xl leading-6">
                            User Score
                        </h1>
                    ...
                    <h1 className="text-lg md:text-xl font-semibold italic text-zinc-200 mt-4">
                        {info.detail.tagline}
                    </h1>
                    ...
                    <div className="mt-6">
                        <h1 className="text-xl md:text-2xl mb-2">Movie Translated</h1>
                        <p className="text-sm md:text-base mb-6">{info.translations.join(", ")}</p>
                    </div>

                    <Link className="inline-block px-4 py-3 md:p-5 bg-[#6556CD] rounded-lg" to={`${pathname}/trailer`}>
            ...
            <div className="w-full md:w-[80%] flex flex-col gap-5 mt-10">
                {info.watchproviders?.flatrate && (
                    <div className="flex flex-wrap gap-5 items-center text-white">
                        <h1 className="text-base md:text-lg">Available on Platforms</h1>
                ...
                {/* Similar providers sections for rent and buy... */}
            </div>
