        ...
        <div className="relative w-full min-h-screen">
            ...
            <div className="relative z-10 p-4 md:px-[10%]">
                ...
                <div className="w-full flex flex-col md:flex-row gap-8">
                    ...
                    <div className="content text-white">
                        <h1 className="text-3xl md:text-5xl font-black">
                            ...
                            <small className="ml-2 text-xl md:text-2xl font-bold text-zinc-200">
                        ...
                        <div className="mt-6">
                            <h2 className="text-xl md:text-2xl mb-2">Movie Languages</h2>
                ...
                <div className="w-full md:w-[80%] flex flex-col gap-5 mt-10">
                    ...
                    {/* Add similar sections for rent and buy if needed */}
                </div>
