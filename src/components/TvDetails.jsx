...
const TvDetails = () => {
    ...
    return info ? (
        <div
            ...
            className="relative w-full min-h-screen p-4 md:px-[10%]"
        >
            {/* Navigation */}
            ...
            <div className="w-full flex flex-col md:flex-row gap-8">
                ...
                <div className="content text-white">
                    ...
                    <div className="mt-3 mb-5 flex flex-wrap items-center gap-3">
                        <span className="rounded-full text-lg md:text-xl font-semibold bg-yellow-600 text-white w-[5vh] h-[5vh] flex justify-center items-center">
                    ...
                    <h2 className="text-lg md:text-xl font-semibold italic text-zinc-200 mt-4">
                        {info.detail.tagline}
                    </h2>
            ...
            <div className="w-full md:w-[80%] flex flex-col gap-5 mt-10">
                {info.watchproviders?.flatrate && (
                    <div className="flex flex-wrap gap-5 items-center text-white">
                        <h2 className="text-base md:text-lg">Available on Platforms</h2>
                ...
                {info.watchproviders?.rent && (
                    <div className="flex flex-wrap gap-5 items-center text-white">
                        <h2 className="text-base md:text-lg">Available on Rent</h2>
                        <div className="flex flex-wrap gap-3">
                ...
                {info.watchproviders?.buy && (
                    <div className="flex flex-wrap gap-5 items-center text-white">
                        <h2 className="text-base md:text-lg">Available to Buy</h2>
                        <div className="flex flex-wrap gap-3">
                    ...
                    <div className="flex gap-4 p-2">
                        {info.detail.seasons.length > 0 ? (
                            info.detail.seasons.map((s, i) => (
                                <div key={i} className="flex-shrink-0 w-[200px] md:w-[15vh]">
                                    <img
                                        className="w-full h-[280px] md:h-[30vh] object-cover rounded-lg shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)]"
